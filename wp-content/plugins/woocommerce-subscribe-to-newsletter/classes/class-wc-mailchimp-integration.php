		...
		if ( ! $stats = get_transient( 'woocommerce_mailchimp_stats' ) ) {
			...
			if ( isset( $lists->status ) && $lists->status === "error" ) {
				...
				foreach ( $lists->data as $list ) {
					...
					$stats .= '<li><strong style="font-size:3em;">' . $list->stats->member_count . '</strong> ' . __( 'Total subscribers', 'wc_subscribe_to_newsletter' ) . '</li>';
					$stats .= '<li><strong style="font-size:3em;">' . $list->stats->unsubscribe_count . '</strong> ' . __( 'Unsubscribes', 'wc_subscribe_to_newsletter' ) . '</li>';
					$stats .= '<li><strong style="font-size:3em;">' . $list->stats->member_count_since_send . '</strong> ' . __( 'Subscribers since last newsletter', 'wc_subscribe_to_newsletter' ) . '</li>';
					$stats .= '<li><strong style="font-size:3em;">' . $list->stats->unsubscribe_count_since_send . '</strong> ' . __( 'Unsubscribes since last newsletter', 'wc_subscribe_to_newsletter' ) . '</li>';
					$stats .= '</ul>';
